...
const outputPath = fileURLToPath(
  new URL(`../${pluginName}/package/${pluginName}.zip`, import.meta.url),
);
const files = [];
...
mkdirSync(
  fileURLToPath(new URL(`../${pluginName}/package/`, import.meta.url)),
  { recursive: true },
);
writeFileSync(outputPath, Buffer.concat([...local, directory, end]));
console.log(`Created ${outputPath} with ${pluginName} at ZIP root.`);
